...
import { fetchSettingsAsync } from '../../modules/StartPage';

declare interface AppProps {
  fetchSettingsAsync: any;
}
const App: React.FC<AppProps> = ({ fetchSettingsAsync }) => {
  useEffect(() => {
    fetchSettingsAsync();
  }, [fetchSettingsAsync]);
...
const mapDispatchToProps = { fetchSettingsAsync: fetchSettingsAsync.request };
